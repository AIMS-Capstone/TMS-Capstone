...
def predict_all():
    ...
    if not purchase_data.empty:
        ...
        print("No purchase data available for prediction.")
    ...
    if not purchase_count_data.empty:
        ...
        print("No purchase count data available for prediction.")
    ...
    if not tax_data.empty:
        ...
        print("No tax data available for prediction.")
    ...
    if not end_of_year_tax_data.empty:
        ...
        print("No end-of-year tax data available for prediction.")
