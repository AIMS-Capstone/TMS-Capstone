...
class PurchaseMultiStepImport extends Component
{
    use WithFileUploads;
    ...
    {
        $this->import = new PurchaseImport();
    }

    public function openModalPurchase()
    {
    ...
    {
        return view('livewire.purchase-multi-step-import', [
