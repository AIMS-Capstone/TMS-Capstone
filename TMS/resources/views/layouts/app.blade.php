...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="w-full flex">
            {{-- Sidebar --}}
            <nav id="sidebar" class="bg-white h-dvh 
            sidebar-open py-6 pr-4 border-r-2 shadow-sm overfow-hidden transition-all duration-500">
                ...
                <div class="content overflow-auto py-6 h-full">
                    <ul class="space-y-1 my-8 flex-1">
                        ...
                        <li x-data="{ open: false }">
                            <button @click="open = !open" type="button"
                                ...
                                :class="open ? 'text-gray-900 dark:text-white' : 'text-gray-500'"
                                ...
                                <div class="flex justify-end pl-4">
                                    <svg :class="open ? 'transform rotate-0' : 'transform rotate-[-90deg]'" class="w-2.5 h-2.5 transition-transform duration-200"
                            ...
                            <ul x-show="open" x-transition class="py-1 space-y-1 taxuri-text">
                                <li>
                                    <a href="#" class="flex items-center w-full p-2 text-[14px] taxuri-text ease-in transition-all rounded-lg pl-11 group">
                                        Percentage Tax
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="flex items-center w-full p-2 text-[14px] text-gray-900 ease-in transition-all rounded-lg pl-11 group">
                                        Income Tax Return
                                    </a>
                                </li>
                                <li>
                        ...
                        <li x-data="{ open: false }">
                            <button @click="open = !open" type="button"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"class="flex-shrink-0 sidebar-icon ease-in transition-all"
                                :class="open ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'"
                            ...
                            <ul x-show="open" x-transition class="py-1 space-y-1">
                                <li>
                                    <a href="#" class="flex items-center w-full p-2 text-[14px] text-gray-900 ease-in transition-all rounded-lg pl-11 group">
                    ...
                    <ul class="space-y-1 my-8 flex-1">
                        <li class="pl-0">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" viewBox="0 0 24 24"><path fill="#172554" d="M4.5 6.375a4.125 4.125 0 1 1 8.25 0a4.125 4.125 0 0 1-8.25 0m9.75 2.25a3.375 3.375 0 1 1 6.75 0a3.375 3.375 0 0 1-6.75 0M1.5 19.125a7.125 7.125 0 0 1 14.25 0v.003l-.001.119a.75.75 0 0 1-.363.63a13.07 13.07 0 0 1-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 0 1-.364-.63zm15.75.003l-.001.144a2.25 2.25 0 0 1-.233.96q.302.018.609.018c1.596 0 3.107-.37 4.451-1.029a.75.75 0 0 0 .42-.642l.004-.204a4.875 4.875 0 0 0-6.961-4.407a8.6 8.6 0 0 1 1.71 5.157z"/></svg>
                        ...
                        <li class="pl-0">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" viewBox="0 0 20 20"><path fill="#172554" d="M11 9V5H9v4H5v2h4v4h2v-4h4V9zm-1 11a10 10 0 1 1 0-20a10 10 0 0 1 0 20"/></svg>
            ...
            <div id="main-content" class="w-full  transition-all duration-300">
                <header id="navbar" class=" bg-gray-100 transition-all duration-300">
                    ...
                    <!-- Page Content -->
                    <main class="transition-all h-dvh duration-300">
                        {{ $slot }}
                    </main>
                </header>
            </div>
