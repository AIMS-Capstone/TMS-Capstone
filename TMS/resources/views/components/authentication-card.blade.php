          ...
          <div class="fixed lg:inset-20 w-full overflow-hidden h-5/6 lg:w-1/2" id = "carousel-container">
              <div class="flex transition-transform duration-500 ease-out w-full h-full" id="carousel">
                ...
                <div class="min-w-full flex-shrink-0 p-12 flex flex-col items-center justify-center">
                    <img src="images/Visual data-pana.png" alt="Slide 1" class="object-cover h-60 lg:w-1/2" />
                ...
                <!-- Slide 2 -->
                <div class="min-w-full flex-shrink-0 p-12 flex flex-col items-center justify-center">
                  <img src="images/Audit-pana.png" alt="Slide 2" class ="object-cover h-52 lg:w-1/2" />
                      <div class="text-center mt-2">
                ...
                <!-- Slide 3 -->
                <div class="min-w-full flex-shrink-0 p-12 flex flex-col items-center justify-center">
                  <img src="images/Data extraction-amico.png" alt="Slide 3" class ="object-cover h-52 lg:w-1/2" />
                      <div class="text-center mt-2">
                        <h2 class="text-2xl font-semibold text-center mt-4">Manage Taxes with Ease</h2>
                        <p class="text-center taxuri-color mt-2">
              ...
              <!-- Indicators -->
             <div class="flex justify-center items-center mt-80 lg:mt-96 xl:mt-80 space-x-3">
                <div class="w-2 h-2 md:w-3 md:h-3 bg-gray-400 rounded-full" id="indicator-1"></div>
                <div class="w-2 h-2 md:w-3 md:h-3 bg-gray-400 rounded-full" id="indicator-2"></div>
                <div class="w-2 h-2 md:w-3 md:h-3 bg-gray-400 rounded-full" id="indicator-3"></div>
              </div>
