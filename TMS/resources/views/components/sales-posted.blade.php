                ...
                <div class="container mx-auto my-4 pt-4">
                    ...
                    <div
                        ...
                        <div class="container mx-auto">
                            <div class="flex flex-row space-x-2 items-center justify-between">
                                <div class="flex flex-row space-x-2 items-center ps-8">
                                    <div class="relative w-80 p-4">
                                        <form x-target="sales-posted-table" action="/sales-book/posted" method="GET" role="search" aria-label="Table" autocomplete="off">
                                            <input
                                                type="search"
                                                name="search"
                            ...
                            <!-- Table for Sales Posted Transactions -->
                            <div x-data="{ checkAll: false, currentPage: 1, perPage: 5 }" class="mb-12 mt-6 mx-12 overflow-hidden max-w-full border-neutral-300" id="sales-posted-table">
                            ...
                            <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full relative" x-show="showConfirmUpdateModal" x-transition:enter="transition ease-out duration-300 transform" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100"
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-zinc-600 text-center mb-6">
                                        You're going to mark as draft the selected item(s) in the Sales Book Journal table.<br>Are you sure?
                                    </p>
                                    <!-- Actions -->
