                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="8" class="text-center p-6">
                                                        ...
                                                        <h1
                                                        <h1 class="font-extrabold mt-4">No Cash Receipt Posted Transactions Available</h1>
                            ...
                            <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full relative" x-show="showConfirmUpdateModal" x-transition:enter="transition ease-out duration-300 transform" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100"
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-zinc-600 text-center mb-6">
                                        You're going to mark as draft the selected item(s) in the Cash Receipt Book table.<br>Are you sure?
                                    </p>
                                    <!-- Actions -->
...
<script>
    ...
    function exportReportExcel() {
        ...
        let url = `{{ route('cash_receipt-posted.exportExcel') }}?year=${year}&month=${month}&period=${period}&quarter=${quarter}&start_month=${startMonth}&end_month=${endMonth}&status=${status}`;
    ...
    function setEntries(entries) {
        ...
        form.method = 'GET';
        form.action = "{{ route('receiptPosted') }}";
