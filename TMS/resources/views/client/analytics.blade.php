<x-client-layout>
                ...
                <div class="container mx-auto my-4 pt-6">
                    ...
                    <div class="flex justify-between items-center px-10">
                        ...
                        <div class="items-end float-end relative sm:w-auto" >
                            <button type="button" id="downloadButton" class="flex items-center text-white font-medium bg-blue-900 rounded-lg text-sm px-5 py-2.5 me-2 mb-2 hover:bg-blue-950 focus:outline-none focus:ring-2 focus:ring-zinc-300">
                        ...
                        <div class="flex justify-center items-center w-52 h-[345px]">
                            <div class="bg-blue-50 rounded-lg p-4 text-center">
                                <div class="flex justify-center">
                                    <img src="{{ asset('images/Visual data-pana.png') }}" class="object-contain h-40" />
                                </div>
    ...
    downloadButton.addEventListener('click', async function() {
        ...
        try {
            ...
            // Get all canvases (charts)
            const canvases = document.querySelectorAll('canvas');
            
            // Convert each canvas to an image and replace the canvas
            ...
            tempContainer.style.width = '1380px'; // Fixed width for consistency
            ...
            pdf.addImage(imgData, 'PNG', x, y, scaledWidth, scaledHeight, null, 'FAST');
            pdf.save('TAXURI_Analytics_Report.pdf');

            // Cleanup
            document.body.removeChild(tempContainer);
            
            // Reload the page to restore the charts
...
const barData = {
    ...
    datasets: [
        ...
        console.log(lineLabels, datasets);
    </script>
</x-client-layout>
