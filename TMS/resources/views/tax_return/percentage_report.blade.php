                ...
                <div class="container mx-auto">
                    <div class="flex justify-between items-center px-8 ps-10 my-4">
                        ...
                        <div class="flex space-x-4">
                            <a href="{{ route('percentage_return.edit', $taxReturn->id) }}" class="border px-6 py-2 text-sm text-zinc-600 rounded-lg hover:border-blue-500 hover:text-blue-500 hover:bg-blue-100 transition flex items-center group">
    ...
    >
        ...
        <div class="flex flex-col items-center">
            ...
            <p class="text-sm text-zinc-600 text-center mb-6">
                The 2551Q Percentage Tax Return has been successfully generated.
            </p>
        </div>
    </div>
</div>
...
>
    ...
    <div class="flex flex-col items-center">
        ...
        <!-- Description -->
        <p class="text-sm text-zinc-600 text-center mb-6">
            The 2551Q Quarterly Percentage Tax Return has been successfully edited.
        </p>
    </div>
</div>
</div>
