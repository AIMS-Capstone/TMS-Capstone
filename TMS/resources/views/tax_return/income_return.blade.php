                ...
                <div class="container mx-auto">
                    <div class="flex flex-row space-x-2 items-center justify-between">
                        ...
                        <div class="relative w-80 p-4">
                            <form x-on:submit.prevent="search" role="search" aria-label="Table" autocomplete="off">
                                <input 
                                    type="search" 
                                    name="search" 
                                    x-model="searchTerm" 
    ...
    <div x-data="{ open: false, selectedType: '', month: '' }" @open-generate-modal.window="open = true" x-cloak>
        <div x-show="open" class="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center">
            <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                <h2 class="text-lg font-semibold mb-4">Generate Income Tax Return</h2>
                                ...
                                @else
                                    @foreach ($taxReturns as $taxReturn)
                                        <tr>
                                            ...
                                            <td class="py-4 px-2">
                                                <x-edit-coa />
                                                <a href="{{ route('income_return.show', ['id' => $taxReturn->id, 'type' => $taxReturn->title]) }}" class="hover:border-slate-600 hover:text-slate-600 border px-3 py-2 rounded-lg text-sm">
                                                    Show
                                                </a>
