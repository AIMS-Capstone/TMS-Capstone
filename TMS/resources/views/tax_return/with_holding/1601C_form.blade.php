            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-6 p-4">
                <form action="{{ route('form1601C.store', ['id' => $withHolding->id]) }}" method="POST">
                    ...
                    <div class="px-8 py-10">
                        ...
                        <!-- Amended Return -->
                        <div class="mb-2 flex flex-row justify-between gap-72">
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            <label for="atc_id" class="indent-4 block text-zinc-700 text-sm w-full"><span class="font-bold mr-2">5</span>Alphanumeric Tax Code (ATC)</label>
                        ...
                        <div class="mb-2 flex flex-row justify-between gap-40">
                            <label for="zip_code" class="indent-4 px-8 block text-zinc-700 text-sm w-2/3"><span class="font-bold mr-2">9A</span>Zip Code</label>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="total_compensation" name="total_compensation" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('gross_compensation') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="statutory_minimum_wage" name="statutory_minimum_wage" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('statutory_minimum_wage') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="thirteenth_month_pay" name="thirteenth_month_pay" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('month_13_pay') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="de_minimis_benefits" name="de_minimis_benefits" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('de_minimis_benefits') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="mandatory_contributions" name="mandatory_contributions" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('sss_gsis_phic_hdmf_union_dues') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="taxable_compensation" name="taxable_compensation" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('taxable_compensation') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="net_taxable_compensation" name="net_taxable_compensation" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('taxable_compensation') - $sources->sum('tax_due') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="total_taxes_withheld" name="total_taxes_withheld" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('tax_due') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="number" id="adjustment_taxes_withheld" name="adjustment_taxes_withheld" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="taxes_withheld_remittance" name="taxes_withheld_remittance" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="{{ $sources->sum('tax_due') }}">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="number" id="tax_remitted_return" name="tax_remitted_return" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="number" id="other_remittances" name="other_remittances" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="total_tax_remittances" name="total_tax_remittances" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer0" readonly value="0">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="tax_still_due" name="tax_still_due" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="0">
                        </div>

                        <!-- Add Penalties -->
                        <h5 class="indent-4 block text-zinc-700 text-sm w-full">Add Penalties</h5>
                        <div class="mb-2 flex flex-row justify-between gap-36">
                            <label for="surcharge" class="indent-4 px-8 block text-zinc-700 text-sm  w-2/3"><span class="font-bold mr-2">32</span>Surcharge</label>
                        ...
                        <div class="mb-2 flex flex-row justify-between gap-36">
                            <label for="interest" class="indent-4 block px-8 text-zinc-700 text-sm  w-2/3"><span class="font-bold mr-2">33</span>Interest</label>
                        ...
                        <div class="mb-2 flex flex-row justify-between gap-36">
                            <label for="compromise" class="indent-4 block px-8 text-zinc-700 text-sm  w-2/3"><span class="font-bold mr-2">34</span>Compromise</label>
                        ...
                        <!-- Total Penalties -->
                        <div class="mb-2 flex flex-row justify-between gap-36">
                            <label for="total_penalties" class="indent-4 block px-8 text-zinc-700 text-sm w-2/3"><span class="font-bold mr-2">35</span>Total Penalties <span class="text-xs italic">(Sum of Items 32 and 34)</span></label>
                            <input type="text" id="total_penalties" name="total_penalties" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer" readonly value="0">
                        </div>
                        ...
                        <div class="mb-2 flex flex-row justify-between">
                            ...
                            <input type="text" id="total_amount_still_due" name="total_amount_still_due" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer0" readonly value="0">
                        </div>
