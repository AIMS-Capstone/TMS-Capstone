                    ...
                    <div class="container mx-auto">
                        <div class="flex flex-row space-x-2 items-center justify-between">
                            ...
                            <div class="relative w-80 p-4">
                                <form x-target="tableid" action="/1601C" role="search" aria-label="Table" autocomplete="off">
                                    <input 
                                        type="search" 
                                        name="search" 
                            ...
                            <tbody>
                                @forelse ($with_holdings as $with_holding)
                                    <tr class="hover:bg-blue-50 cursor-pointer ease-in-out">
                                        ...
                                        <td class="py-3 px-4" onclick="window.location='{{ route('with_holding.1601C_summary', ['id' => $with_holding->id]) }}'"> {{ $with_holding->title ?? 'N/A' }}</td>
                                        <td class="py-3 px-4">
