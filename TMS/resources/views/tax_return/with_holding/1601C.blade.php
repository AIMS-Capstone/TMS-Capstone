...
<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div x-data="{
                    ...
                    deleteRows() {
                        ...
                        fetch('/tax_return/with_holding/1601C/destroy', {
                            method: 'POST',
                            headers: {
                    ...
                    <div class="container mx-auto">
                                ...
                                <div x-show="open" class="fixed inset-0 bg-gray-200 bg-opacity-50 z-50 flex items-center justify-center transition-opacity"
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg max-w-lg w-full mx-auto h-auto z-10 overflow-hidden">
                                        <div class="relative p-3 bg-blue-900 border-opacity-80 w-full">
                                            <h1 class="text-lg font-bold text-white text-center">Monthly Remittance Return of Income<br>Taxes Withheld on Compensation</h1>
                                        ...
                                        <div class="p-10">
                                            <form method="POST" action="{{ route('with_holding.1601C.generate') }}">
                                                @csrf
                        ...
                        <div class="mb-12 mt-1 mx-12 overflow-hidden max-w-full border-neutral-300">
                            <div class="overflow-x-auto">
                                <table class="w-full items-start text-left text-sm text-neutral-600 p-4" id="table1601C">
                                    ...
                                    <tbody class="divide-y divide-neutral-300 text-left py-[7px]">
                                        @forelse ($with_holdings as $with_holding)
                                            <tr class="hover:bg-blue-50 cursor-pointer ease-in-out">
                                                ...
                                                <td class="py-3 px-4 font-bold hover:underline hover:text-blue-500" 
                                            ...
                                            <div class="bg-zinc-200 rounded-lg shadow-lg p-6 max-w-sm w-full">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-sm text-zinc-600 text-center">
                                                        You're going to delete permanently the selected withholding 1601C item(s). Are you sure?
                                                    </p>
                                            ...
                                            <div class="bg-zinc-200 rounded-lg shadow-lg p-6 max-w-sm w-full">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-sm text-zinc-700 text-center">
                                                        The selected withholding 1601C have been move to recyle bin.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function sortItems(criteria) {
            const table = document.querySelector('#table1601C tbody');
        ...
        function setEntries(entries) {
            ...
            form.method = 'GET';
            form.action = "{{ route('with_holding.1601C') }}";
