...
<x-app-layout>
                    ...
                    <div class="container mx-auto overflow-hidden">
                        <div class="container mx-auto ps-8">
                            <div class="flex flex-row space-x-2 items-center justify-center">
                                <div x-data="{selectedType: new URLSearchParams(window.location.search).get('type') || 'Schedule 2',
                        ...
                        <div class="mb-12 mt-6 mx-12 overflow-hidden max-w-full border-neutral-300">
                            <div class="text-sm font-bold text-neutral-700 mb-4"><p>Schedule 2 - Alphalist of Employees (Minimum Wage Earners)</p></div>
                                    ...
                                    <tbody class="divide-y divide-neutral-300 text-left py-[7px]">
                                        @forelse ($aggregatedData as $data)
                                            <tr class="hover:bg-blue-50 cursor-pointer ease-in-out">
                                                <td class="px-4 py-4">{{ $data['employee']->first_name ?? 'N/A' }} {{ $data['employee']->last_name ?? '' }}</td>
                                                <td class="px-4 py-4">{{ number_format($data['gross_compensation'], 2) }}</td>
                                                <td class="px-4 py-4">{{ number_format($data['non_taxable_compensation'], 2) }}</td>
                                                <td class="px-4 py-4">{{ number_format($data['taxable_compensation'], 2) }}</td>
                                                <td class="px-4 py-4">{{ number_format($data['tax_due'], 2) }}</td>
                                            </tr>
                                        @empty
                                            <tr>
    ...
    <script>
        ...
        function setEntries(entries) {
            ...
            form.method = 'GET';
            form.action = "{{ route('with_holding.1604C_schedule2', ['id' => $with_holding->id]) }}";
