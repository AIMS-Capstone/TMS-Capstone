            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex flex-row justify-center items-center space-x-4">
                    <div class="flex border-b-8 border-sky-900">
                        <a href="{{ route('with_holding.1604E_sources', ['id' => $with_holding->id]) }}"><p>Schedule 3</p></a>
                    </div>
                    <div>
                        {{-- <a href="{{ route('with_holding.1604E_schedule4', ['id' => $with_holding->id]) }}"><p>Schedule 4</p></a> --}}
                    </div>
                </div>
