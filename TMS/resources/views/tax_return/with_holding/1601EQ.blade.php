...
<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div x-data="{
                    ...
                    <div class="container mx-auto">
                        <div class="flex flex-row space-x-2 items-center justify-between">
                            <div class="flex flex-row space-x-2 items-center ps-6">
                                <div class="relative w-80 p-5">
                                        <form x-target="table1601EQ" action="/tax_return/with_holding/1601EQ" role="search" aria-label="Table" autocomplete="off">
                                            <input 
                                            type="search" 
                                            name="search"
                        ...
                        <div x-data="{selectedTab: '1601EQ'}" class="w-full p-5">
                            ...
                            <div x-data="{ open: false, month: '', year: '' }" @open-generate-modal.window="open = true" x-cloak>
                                <!-- Modal Background -->
                                <div x-show="open" class="fixed inset-0 bg-gray-200 bg-opacity-50 z-50 flex items-center justify-center transition-opacity" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg max-w-lg w-full mx-auto h-auto z-10 overflow-hidden">
                                        <div class="relative p-3 bg-blue-900 border-opacity-80 w-full">
                                            <h1 class="text-lg font-bold text-white text-center">Quarterly Remittance Form of Creditable<br>Income Taxes Withheld (Expanded)</h1>
                                        ...
                                        <div class="p-10">
                                            <form method="POST" action="{{ route('with_holding.1601EQ.generate') }}">
                                                ...
                                                <div class="grid grid-cols-2 gap-6 mb-5">
                                                    ...
                                                    <!-- Quarterly Selection -->
                                                    <div class="mb-4">
                                                        <label for="quarter" class="block text-sm font-bold text-zinc-700">Quarter</label>
                                                        <select id="quarter" name="quarter" x-model="quarter" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer"
                                                            required>
                        ...
                        <div class="mb-12 mt-1 mx-12 overflow-hidden max-w-full border-neutral-300">
                            <div class="overflow-x-auto">
                                <table class="w-full items-start text-left text-sm text-neutral-600 p-4" id="table1601EQ">
                                        ...
                                        @forelse ($with_holdings as $with_holding)
                                            <tr class="hover:bg-blue-50 cursor-pointer ease-in-out">
                                                ...
                                                <td class="py-3 px-4 font-semibold hover:font-bold hover:underline hover:text-blue-500" 
                                                    onclick="window.location='{{ route('with_holding.1601EQ_Qap', ['id' => $with_holding->id]) }}'">{{ $with_holding->title ?? 'N/A' }}</td>
                                                <td class="py-3 px-4">      
                                            ...
                                            <div class="bg-zinc-200 rounded-lg shadow-lg p-6 max-w-sm w-full">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-sm text-zinc-600 text-center">
                                                        You're going to delete permanently the selected withholding 1601EQ item(s). Are you sure?
                                                    </p>
                                            ...
                                            <div class="bg-zinc-200 rounded-lg shadow-lg p-6 max-w-sm w-full">
                                                <div class="flex flex-col items-center">
                                                    ...
                                                    <p class="text-sm text-zinc-700 text-center">
                                                        The selected withholding 1601EQ have been move to recyle bin.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div x-show="showDeleteCancelButtons" class="flex justify-center py-4" x-cloak>
                        <button @click="showConfirmDeleteModal = true; showDeleteCancelButtons = true;" 
    ...
    <script>
        ...
        function sortItems(criteria) {
            const table = document.querySelector('#table1601EQ tbody');
        ...
        function setEntries(entries) {
            ...
            form.method = 'GET';
            form.action = "{{ route('with_holding.1601EQ') }}";
