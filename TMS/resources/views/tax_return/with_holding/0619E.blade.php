...
<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('with_holding.0619E') }}" 
                                    class="ms-1 text-sm font-medium {{ Request::routeIs('with_holding.0619E') ? 'font-extrabold text-blue-900' : 'text-zinc-500' }} md:ms-2">
                                    0619E
                                </a>
                            </div>
                            </li>
                ...
                <div x-data="{
                    ...
                    <div class="container mx-auto">
                        ...
                        <div x-data="{selectedTab: '0619E'}" class="w-full p-5">
                            ...
                            <div x-data="{ open: false, month: '', year: '' }" @open-generate-modal.window="open = true" x-cloak>
                                <!-- Modal Background -->
                                <div x-show="open" class="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center transition-opacity" x-transition:enter="transition ease-out duration-200"
                                    x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100"
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg max-w-lg w-full mx-auto h-auto z-10 overflow-hidden">
                                        <div class="relative p-3 bg-blue-900 border-opacity-80 w-full">
                                            <h1 class="text-lg font-bold text-white text-center">Monthly Remittance Form of Creditable<br>Income Taxes Withheld (Expanded)</h1>
                                        ...
                                        <div class="p-10">
                                            <form method="POST" action="{{ route('with_holding.0619E.generate') }}">
                                                @csrf
                                                <div class="grid grid-cols-2 gap-6 mb-5">
                                                    <input type="hidden" name="type" value="0619E">
                                                    <!-- Year Selection -->
                                                    <div class="w-full">
                                                    ...
                                                    <!-- Month Selection -->
                                                    <div class="w-full">
                                                        <label for="month" class="block text-sm font-bold text-gray-700">Month</label>
                                                        <select id="month" name="month" x-model="month" class="block w-full py-2 px-0 text-sm text-zinc-700 bg-transparent border-0 border-b-2 border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-900 peer"
                                                            required>
                        ...
                        <div class="mb-12 mt-1 mx-12 overflow-hidden max-w-full border-neutral-300">
                            <div class="overflow-x-auto">
                                <table  class="w-full items-start text-left text-sm text-neutral-600 p-4" id="table0619E">
                                    <thead class="bg-neutral-100 text-sm text-neutral-700">
                                        <tr>
                                            ...
                                            <th scope="col" class="py-4 px-4 text-left">Title</th>
                                            <th scope="col" class="py-4 px-4 text-left">Period</th>
                                            <th scope="col" class="py-4 px-4 text-left">Created By</th>
                                            <th scope="col" class="py-4 px-4 text-left">Status</th>
                                            <th scope="col" class="py-4 px-4 text-left">Date Created</th>
                                        </tr>
                                    </thead>
                                    <tbody class="divide-y divide-neutral-300 py-[7px]">
                                        @forelse ($with_holdings as $with_holding)
                                            <tr class="hover:bg-blue-50 cursor-pointer ease-in-out">
                                                ...
                                                <td class="py-3 px-4"><span class="bg-zinc-100 text-zinc-800 text-xs px-4 py-2 rounded-full">{{ $with_holding->status ?? 'N/A' }}</span></td>
    ...
    <script>
        ...
        function sortItems(criteria) {
            const table = document.querySelector('#table0619E tbody');
        ...
        function setEntries(entries) {
            ...
            form.method = 'GET';
            form.action = "{{ route('with_holding.0619E') }}";
