...
<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div x-data="{
                    ...
                    <div class="container mx-auto">
                        <div class="flex flex-row space-x-2 items-center justify-between">
                            <div class="flex flex-row space-x-2 items-center ps-6">
                                <div class="relative w-80 p-5">
                                        <form x-target="table1604E" action="/tax_return/with_holding/1604E" role="search" aria-label="Table" autocomplete="off">
                                            <input 
                                            type="search" 
                                            name="search"
                        ...
                        <div x-data="{selectedTab: '1604E'}" class="w-full p-5">
                                ...
                                <div x-show="open" class="fixed inset-0 bg-gray-200 bg-opacity-50 z-50 flex items-center justify-center transition-opacity"
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg max-w-lg w-full mx-auto h-auto z-10 overflow-hidden">
                                        <div class="relative p-3 bg-blue-900 border-opacity-80 w-full">
                                            <h1 class="text-lg font-bold text-white text-center">Annual Information Return of Creditable<br>Income Taxes Withheld (Expanded)</h1>
                                        ...
                                        <div class="p-10">
                                            <form method="POST" action="{{ route('with_holding.1604E.generate') }}">
                                                @csrf
                                                <input type="hidden" name="type" value="1604E">
                                                <!-- Year Selection -->
                                                <div class="mb-4">
                        ...
                        <div class="mb-12 mt-1 mx-12 overflow-hidden max-w-full border-neutral-300">
                            <div class="overflow-x-auto">
                                <table class="w-full items-start text-left text-sm text-neutral-600 p-4" id="table1604E">
                                        ...
                                        @forelse ($with_holdings as $with_holding)
                                            <tr class="hover:bg-blue-50 cursor-pointer ease-in-out">
                                                ...
                                                <td class="py-3 px-4 font-semibold hover:font-bold hover:underline hover:text-blue-500"
                                                    onclick="window.location='{{ route('with_holding.1604E_summary', ['id' => $with_holding->id]) }}'">{{ $with_holding->title ?? 'N/A' }}</td>
                                                <td class="py-3 px-4">
    ...
    <script>
        ...
        function sortItems(criteria) {
            const table = document.querySelector('#table1604E tbody');
        ...
        function setEntries(entries) {
            ...
            form.method = 'GET';
            form.action = "{{ route('with_holding.1604E') }}";
