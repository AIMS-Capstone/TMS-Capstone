                ...
                <div class="p-8 bg-white border-b border-gray-200">
                    ...
                    <div class="px-4 grid grid-cols-12 gap-5 mb-6">
                        <div class="col-span-12 border">
                            <div class="font-bold text-sm text-left bg-neutral-100 text-neutral-700 p-2">Background Information</div>
                                ...
                                <div class="p-8">
                                    <form action="{{ route('tax_return.background_information.update', ['id' => $taxReturn->id]) }}" method="POST">
                                        ...
                                        <div x-show="step === 1" class="mb-4 grid grid-cols-12 gap-4">
                                            <div class="col-span-4 p-4 text-sm font-medium text-gray-700">
                                                <label class="font-bold text-zinc-700">Select Date of Birth</label>
