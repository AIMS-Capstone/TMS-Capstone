                ...
                <div class="p-6 bg-white whitespace-nowrap overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="grid grid-cols-2 grid-row-3">
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <span class="font-bold text-2xl taxuri-color leading-tight">Return Summary</span>
                        </div>
                        <div class="flex items-center justify-end mb-4">
                            <a href="anu-itu" class="flex items-center space-x-2 font-bold text-sm underline decoration-2 taxuri-color leading-tight">
