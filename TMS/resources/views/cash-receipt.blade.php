                ...
                <div class="container mx-auto my-4 pt-4">
                    ...
                    <div class="flex justify-between items-center px-10">
                        <div class="flex items-center">            
                            <p class="font-normal text-sm">This book houses all the bills that are marked as paid in the Transactions Module.</p>
                        </div>
                    </div>  
                    <br>
                                ...
                                <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full relative">
                                    ...
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-sm text-gray-600 text-center mb-6">
                                            You're going to mark as posted the selected item/s in the Cash Book Journal table. Are you sure?
                                        </p>
