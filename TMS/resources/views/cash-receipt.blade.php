            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" x-data="filterComponent()">
                <div class="container mx-auto my-4 pt-4">
                    <div class="flex justify-between items-center px-10">
                        <p class="font-bold text-3xl text-left taxuri-color">Cash Receipt Book</p>
                    </div>
                    <div class="flex justify-between items-center px-10">
                        <div class="flex items-center">            
                            <p class="taxuri-text font-normal text-sm">This book houses all the bills that are marked as paid in the Transactions Module.</p>
                        </div>
                    ...
                    <div class=" grid grid-cols-8 gap-4 mx-10 overflow-x-auto whitespace-nowrap max-w-full custom-scrollbar">
                        <div class="flex items-center space-x-8 ps-6">
                            <div class="col-span-2 p-4 text-blue-900">
                                <p class="font-normal">Filter: <b>Cash Receipt Book</b></p>
                                <p class="font-normal" x-text="getFormattedDate()"></p>
                            </div>

                            <div class="flex items-center space-x-4">
                                <div class="flex flex-col w-32">
                                    <label for="period_select" class="font-bold text-blue-900">Period of Time</label>
                            ...
                            <div class="flex flex-row space-x-2 items-center justify-between">
                                <div class="flex flex-row space-x-2 items-center ps-8">
                                    ...
                                    <div class="relative w-80 p-4">
                                        <form x-target="cash-table" action="/cash-receipt" role="search" aria-label="Table" autocomplete="off">
                                            <input 
                                            type="search" 
                                            name="search" 
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="9" class="text-center p-6">
                                                        ...
                                                        <h1 class="font-extrabold mt-4">No Cash Receipt Transactions Available</h1>
                                                        <p class="text-sm text-neutral-500 mt-2">You can start adding new transactions by <br> going to the transactions page.</p>
                                                    </td>
                                                </tr>
                                            @endif
                                        </tbody>
                            ...
                            <div class="bg-white rounded-lg shadow-lg p-8 mx-auto overflow-hidden flex justify-center max-w-sm w-full relative" x-show="showConfirmUpdateModal" x-transition:enter="transition ease-out duration-300 transform" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100"
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-zinc-600 text-center mb-6">
                                        You're going to mark as posted the selected<br>item(s) in the Cash Receipt Book table. <br>Are you sure?
                                    </p>
...
<script>
    ...
    function exportReportExcel() {
        ...
        let url = `{{ route('cash_receipt.exportExcel') }}?year=${year}&month=${month}&period=${period}&quarter=${quarter}&start_month=${startMonth}&end_month=${endMonth}&status=${status}`;
    ...
    function setEntries(entries) {
        ...
        form.method = 'GET';
        form.action = "{{ route('cash-receipt') }}";
