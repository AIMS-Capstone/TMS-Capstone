        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <nav class="text-sm font-medium text-gray-600 dark:text-slate-300 mb-6" aria-label="breadcrumb">
                <ol class="flex flex-wrap items-center gap-1">
                    ...
                    <li class="flex items-center gap-1">
                        <a href="{{ route('cash-receipt') }}" class="hover:text-blue-950 dark:hover:text-white {{ request()->routeIs('cash-receipt') ? 'breadcumb-active' : '' }}">Cash Book Journal</a>
                    </li>
                </ol>
            </nav>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="9" class="text-center p-6">
                                                ...
                                                <h1 class="font-extrabold mt-4">No Cash Transactions Available</h1>
