                ...
                <div class="container mx-auto my-4 pt-4">
                    ...
                    <div
                        ...
                        <div class="container mx-auto">
                            <div class="flex flex-row space-x-2 items-center justify-between">
                                <div class="flex flex-row space-x-2 items-center ps-8">
                                    ...
                                    <div class="relative w-80 p-4">
                                        <form x-target="sales-table" action="/sales-book" role="search" aria-label="Table" autocomplete="off">
                                            <input 
                                            type="search" 
                                            name="search" 
                            ...
                            <div x-data="{ checkAll: false, currentPage: 1, perPage: 5 }" class="mb-12 mt-6 mx-12 overflow-hidden max-w-full border-neutral-300" id="sales-table">
                                                ...
                                                @foreach($transactions as $transaction)
                                                    ...
                                                    <tr class="border-b hover:bg-gray-50">
                                                        ...
                                                        <td class="p-4">
                                                            ...
                                                            {{ $transaction->contactDetails->contact_address ?? 'N/A' }}<br>{{ $transaction->contactDetails->contact_tin ?? 'N/A' }}
                                                        </td>
...
<script>
    ...
    return {
        ...
        async applyFilters() {
            ...
            .then(html => {
                ...
                const newTableContent = doc.querySelector('#sales-table').innerHTML;
                document.querySelector('#sales-table').innerHTML = newTableContent;
            })
    ...
    function exportReportExcel() {
        ...
        let url = `{{ route('sales.exportExcel') }}?year=${year}&month=${month}&period=${period}&quarter=${quarter}&start_month=${startMonth}&end_month=${endMonth}&status=${status}`;
