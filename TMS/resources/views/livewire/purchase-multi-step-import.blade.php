            ...
            <div class="bg-white rounded-lg w-full max-w-screen-lg max-h-[100%] mx-auto z-10 overflow-y-auto my-auto">
                ...
                <div class="flex relative justify-between items-center mb-4 bg-blue-900 border-opacity-80 w-full p-3">
                    <div class="flex justify-center items-center bg-blue-900 border-opacity-80 w-full">
                        <h1 class="text-lg font-bold text-white">Purchases Transactions Source</h1>
                        <button 
                ...
                @if($step === 1)
                    ...
                    <div class="px-20">
                        <div class="flex flex-col space-y-4 justify-center items-center h-full">
                            <div class="p-6 h-full max-h-screen-md w-full max-w-screen-lg border rounded-sm flex flex-col leading-tight">
                                <div class="flex flex-col text-center justify-center items-center text-blue-900 font-bold">
                                    ...
                                    <p class="text-[11px] font-light text-zinc-600">By default, any CSV file can be imported by mapping the required fields<br>against the columns in your file.</p>
                                </div>
                                        ...
                                        <ul class="list-disc text-[11px]">
                                            ...
                                            <li>
                                                <span class="inline-block align-top">
                                                    a Purchase Category column to specify the category for each transaction:
                                                    <p>V = Goods</p>
                                                    <p>S = Services</p>
                                                    <p>SNQ = Services Not Qualified for Input Tax</p>
                                                    <p>GNQ = Goods Not Qualified for Input Tax</p>
                                                    <p>SNR = Service by Non-residents</p>
                                                    <p>NT = Non Tax</p>
                                                    <p>CG = Capital Goods</p>
                                                    <p>I = Implications</p>
                                                </span>
                                            </li>
                                        </ul>
                        ...
                        <div class="w-full justify-start">
                            <label class="block font-bold text-sm text-zinc-700 mb-2">Choose a file to import.</label>
