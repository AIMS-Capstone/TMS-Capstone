            ...
            <div class="bg-white rounded-lg w-full max-w-screen-lg max-h-[100%] mx-auto z-10 overflow-y-auto my-auto">
                ...
                <div class="flex relative justify-between items-center mb-4 bg-blue-900 border-opacity-80 w-full p-3">
                    <div class="flex justify-center items-center bg-blue-900 border-opacity-80 w-full">
                        <h1 class="text-lg font-bold text-white">Manual Journal Transactions Source</h1>
                        <button 
                ...
                @if($step === 1)
                    <div class="px-20">
                        ...
                        <div class="mb-8 flex justify-end">
                            <button wire:click="closeModal" class="-mt-2 rounded-md border px-4 py-1.5 border-blue-900 text-blue-900 font-bold hover:text-white hover:bg-blue-900 p-2 mr-2">Cancel</button>
                        </div>   
                    </div>
                @endif
                                ...
                                <div class="p-6 h-full max-h-screen-md w-full max-w-screen-lg border rounded-sm flex flex-col">
                                    ...
                                    <div class="flex justify-center items-center">
                                        <div class="w-full max-w-md">
                                            ...
                                            @endphp
                                            <div class="mt-4">
                                                @foreach($databaseColumns as $field => $label)
                        ...
                        <div class="flex flex-col space-y-2 justify-center items-center">
                            <div class="p-6 h-full max-h-screen-md w-full max-w-screen-lg border rounded-sm flex flex-col">
                                ...
                                <div class="text-xs text-zinc-700 mt-6">
                                    ...
                                    <p class="flex items-center pl-24 font-bold italic mt-2 mb-4">Here is a preview of how the transaction(s) will be mapped:</p>
                                </div>
