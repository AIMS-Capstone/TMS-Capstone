<tr>
    ...
    <td class="border px-4 py-2">
        <select name="tax_type" class="form-control mt-2 w-full select2 block py-2.5 px-0 text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-900 peer" id="tax_type" wire:model.live="tax_type">
    ...
    <!-- ATC -->
    <td class="border px-4 py-2">
        <select class="block w-full h-full border-none select2 py-2.5 px-0 text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-900 peer" id="tax_code" wire:model.live="tax_code">
            <option value="" disabled selected></option>
            @foreach($atcs as $atc)
    ...
    <!-- COA -->
    <td class="border px-4 py-2">
        <select class="block w-full h-full border-none select2 py-2.5 px-0 text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-blue-900 peer" id="coa" wire:model="coa">
            <option value="" disabled selected></option>
            @foreach($coas as $coa)
