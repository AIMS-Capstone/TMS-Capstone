                ...
                <div class="container mx-auto my-4 pt-4">
                    ...
                    <div class="flex justify-between items-center px-10">
                        <div class="flex items-center">            
                            <p class="taxuri-text font-normal text-sm">This book houses all the Purchase entered in the Transactions Module.</p>
                        </div>
                    ...
                    <div
                        ...
                        <div class="container mx-auto">
                            ...
                            <!-- Table for Purchases -->
                            <div x-data="{ checkAll: false, currentPage: 1, perPage: 5 }" class="mb-12 mt-6 mx-12 overflow-hidden max-w-full border-neutral-300" id="purchase-table">
                                <div class="overflow-x-auto">
                                    ...
                                    @if (count($transactions) > 0)
                                        <div class="mt-4">
                                            {{ $transactions->links('vendor.pagination.purchase') }}
                                        </div>
                                    @endif
                            ...
                            x-transition:leave="transition ease-in duration-200 transform" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90">
                                ...
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-zinc-600 text-center mb-6">
                                        You're going to mark as posted the selected<br>item(s) in the Purchase Book Journal table. <br>Are you sure?
                                    </p>
...
<script>
    ...
    function exportReportExcel() {
        ...
        let url = `{{ route('purchase.exportExcel') }}?year=${year}&month=${month}&period=${period}&quarter=${quarter}&start_month=${startMonth}&end_month=${endMonth}&status=${status}`;
    ...
    function setEntries(entries) {
        ...
        form.method = 'GET';
        form.action = "{{ route('purchase-book') }}";
