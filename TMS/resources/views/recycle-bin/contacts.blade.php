                                            ...
                                            @else
                                                @foreach($trashedContacts as $contact)
                                                    <tr class="hover:bg-slate-100 cursor-pointer ease-in-out">
                                                        ...
                                                        <td class="p-4">{{ \Carbon\Carbon::parse($contact->deleted_at)->format('F d, Y h:i A') ?? 'N/A' }}</td>
                                ...
                                <div 
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full relative">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <!-- Title -->
                                            <h2 class="text-2xl font-extrabold text-zinc-800 mb-2">Delete Contact(s)</h2>

                                            <!-- Description -->
                                            <p class="text-sm text-zinc-600 text-center">
                                                You're going to delete permanently the selected contact(s) in the Contact Recycle Bin table. Are you sure?
                                            </p>
