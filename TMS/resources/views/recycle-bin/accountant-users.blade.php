                                                ...
                                                @foreach($trashedAccountantUsers as $AccountantUser)
                                                    <tr>
                                                        <td class="py-3 px-4">
                                                            <input 
                                                                type="checkbox" 
                                                                :checked="selectedRows.includes(@json($AccountantUser->id))" 
                                                                @click="toggleCheckbox(@json($AccountantUser->id))" 
                                                                aria-label="Select item {{ $AccountantUser->name }}" 
                                                                data-accountant-user-id="{{ $AccountantUser->id }}"
                                                            >
                                                        </td>
                                                        <td class="py-3 px-4">{{ $AccountantUser->name }}</td>
