                            ...
                            <div x-data="recycleBinHandler">
                                ...
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="relative w-80 p-5">
                                        <form x-target="emplyees-table" action="{{ route('recycle-bin.employees.index') }}" method="GET" role="search" aria-label="Table" autocomplete="off">
                                            <input 
                                            type="search" 
                                            name="search" 
                                ...
                                <div x-show="showConfirmDeleteModal" class="fixed inset-0 bg-gray-200 z-50 bg-opacity-50 flex justify-center items-center" @click.away="showConfirmDeleteModal = false"
                                    ...
                                    <div class="bg-white p-10 rounded-lg shadow-lg max-w-lg w-full relative">
                                        ...
                                        <h2 class="text-xl text-zinc-700 font-bold text-start mb-4">Permanently Delete Employee(s)</h2>
                                        <p class="text-start mb-6 text-sm text-zinc-700">Are you sure you want to permanently delete the selected employee(s) to the recycle bin?</p>
                                        <div class="bg-red-100 border-l-8 border-red-500 text-red-500 p-6 rounded-lg mb-6">
                                            <ul class="list-disc pl-5 text-[13px]">
                                                <li class="pl-2">
                                                    <span class="inline-block align-top">This action cannot be undone, and the employee(s) will be completely removed from the system.</span>
                                                </li>
                                                <li class="pl-2">
                                                    <span class="inline-block align-top">Any process or reports tied to this employee(s) will be affected.</span>
                                                </li>
                                                <li class="pl-2">
                                                    <span class="inline-block align-top">Proceed only if you’re sure this employee(s) should<br />be removed from access.</span>
                                                </li>
                                            </ul>
                                        </div>
