                    ...
                    <div 
                                    x-data="{
                                        ...
                                        toggleCheckbox(id) {
                                            ...
                                            this.checkAll = this.selectedRows.length === {{ json_encode($trashedClientUsers->count()) }};
                                        },
                                        toggleAll() {
                                            this.checkAll = !this.checkAll;
                                            if (this.checkAll) {
                                                this.selectedRows = {{ json_encode($trashedClientUsers->pluck('id')->toArray()) }}; 
                                            } else {
                                        ...
                                        deleteRows() {
                                            ...
                                            fetch('{{ route('recycle-bin.client-users.bulkDelete' ) }}', {
                                                method: 'DELETE',
                                                headers: {
                                        ...
                                        restoreRows() {
                                            ...
                                            fetch('{{ route('recycle-bin.client-users.bulkRestore' ) }}', {
                                                method: 'POST',
                                                headers: {
                                                    'Content-Type': 'application/json',
                                                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
                            ...
                            <div x-data="recycleBinHandler">
                                ...
                                <div class="flex flex-row items-center">
                                    <div class="relative w-80 p-5">
                                        <form x-target="client-table" action="/recycle-bin/client-users" role="search" aria-label="Table" autocomplete="off">
                                            <input 
                                            type="search" 
                                            name="search"
                                                    ...
                                                    <tr class="hover:bg-slate-100 cursor-pointer ease-in-out">
                                                        ...
                                                        <!-- Body Checkbox for Individual Selection -->
                                                            <label x-show="showCheckboxes" class="flex items-center cursor-pointer text-neutral-600" x-cloak>
                                                                <div class="relative flex items-center">
                                                                    <input type="checkbox" @click="toggleCheckbox('{{ $clientUser->id }}')" :checked="selectedRows.includes('{{ $clientUser->id }}')" id="clientUser{{ $clientUser->id }}" 
                                                        ...
                                                        <td>
                                                            ...
                                                            x-on:click="$dispatch('open-view-client-modal', {
                                                                ...
                                                                email: '{{ $clientUser->orgSetup->email ?? 'N/A' }}', 
                                                        ...
                                                        <td class="p-4">{{ \Carbon\Carbon::parse($clientUser->deleted_at  )->format('F d, Y h:i A') ?? 'N/A' }}</td>
                                    ...
                                    <div 
                                        ...
                                        <div class="bg-white rounded-lg shadow-lg p-6 max-w-md w-full relative">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <!-- Title -->
                                                <h2 class="text-2xl font-extrabold text-blue-600 mb-2">Restore Client(s)</h2>

                                                <!-- Description -->    
                                                <p class="text-sm text-zinc-700 text-center">You're going to restore the selected client(s) in the Recycle Bin table. Are you sure?</p>
                                    ...
                                    <div 
                                        ...
                                        <div class="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full relative">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <!-- Title -->
                                                <h2 class="text-2xl font-extrabold text-zinc-800 mb-2">Delete Client(s)</h2>

                                                <!-- Description -->
                                                <p class="text-sm text-zinc-600 text-center">
                                                    You're going to delete permanently the selected account(s) in the Client Recycle Bin table. Are you sure?
                                                </p>
