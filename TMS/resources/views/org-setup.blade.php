                                            ...
                                            <tr>
                                                <form action="{{ route('org-dashboard') }}" method="POST" id="form-{{ $organization->id }}">
                                                    ...
                                                    <td class="text-left py-2 px-3 text-blue-600 underline">
                                                        <button type="submit" class="text-blue-600 underline flex items-center space-x-1">Open Organization
                                                            <span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 16 16"><path fill="#2563eb" d="M8.22 2.97a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.042-.018a.75.75 0 0 1-.018-1.042l2.97-2.97H3.75a.75.75 0 0 1 0-1.5h7.44L8.22 4.03a.75.75 0 0 1 0-1.06"/></svg>
                                                            </span>
                                                        </button>
                                                    </td>
